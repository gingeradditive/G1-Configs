...
def write_printer_cfg():
    ...
    with open(printerCfgPath, "w") as outfile:
        #values[key]
        outfile.write('############################ G1 Configuration #############################\n')
        outfile.write('#\n')
        outfile.write('# WARNING: this file is generated by the configuration tool.\n')
        ...
        outfile.write('[include G1-Configs/material.cfg]\n')
        ...
        if(values["extruder_stepper_model_select"] == "tmc5160"):
            ...
            outfile.write('run_current: ' + values["mixing_stepper/run_current"] + '\n')
        ...
        outfile.write('#rotation_distance is the volume of material (mm^3) extruded per rotation\n')
        outfile.write('\n')
        outfile.write('full_steps_per_rotation: 200\n')
        outfile.write('gear_ratio: 5:1 \n')
        outfile.write('nozzle_diameter: 1\n')
        outfile.write('filament_diameter: 1.1284 #con questo valore i mm di filamento equivalgono ai mm^3\n')
        outfile.write('max_extrude_cross_section: 150\n')
        outfile.write('step_pulse_duration: 0.00002 #10 volte gli altri driver dovrebbe bastare\n')
        ...
        outfile.write('#max_extruder_velocity: 100 #max_volumeric_speed / ((filament_diameter / 2)^2 * PI()) 100 è tipo 250mm3/s\n')
        ...
        outfile.write('min_extrude_temp: ' + values["extruder/min_extrude_temp"] + '\n')
        outfile.write('\n')
        ...
        outfile.write('\n')
        outfile.write('# delayed Gcode for checking the status of the feeder sensor every 1 second \n')
        ...
        outfile.write('gcode:\n')
        outfile.write('  {% if printer["filament_switch_sensor FEEDER"].enabled %}\n')
        outfile.write('    SET_PIN PIN=FEEDER_STATUS VALUE=1\n')
        outfile.write('  {% else %}\n')
        outfile.write('    SET_PIN PIN=FEEDER_STATUS VALUE=0\n')
        outfile.write('  {% endif %}\n')
        outfile.write('  UPDATE_DELAYED_GCODE ID=FEEDER_CHECK_STATUS DURATION=1.0\n')
        outfile.write('\n')
        outfile.write('# delayed Gcode for deactivate the feeder sensor on startup\n')
        ...
        outfile.write('minimum_pulse_width: 0.00077 #valore che corrisponde allo zero\n')
        outfile.write('maximum_pulse_width: 0.00216 #valore che corrisponde al maximum_servo_angle\n')
        ...
        outfile.write('horizontal_move_z: 20 #15; Da scegliere a seconda dello z offset, deve essere di più\n')
        ...
        outfile.write('position_max: ' + values["stepper_x/position_max"] + '\n')
        ...
        outfile.write('position_endstop: 0\n')
        outfile.write('position_max: ' + values["stepper_y/position_max"] + '\n')
        outfile.write('homing_speed: 40\n')
        outfile.write('homing_retract_dist: 5\n')
        outfile.write('homing_retract_speed: 20\n')
        outfile.write('second_homing_speed: 10\n')
        ...
        outfile.write('position_max: ' + values["stepper_z/position_max"] + '\n')
