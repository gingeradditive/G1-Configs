...
$.ajax({
    ...
    success: function (response) {
        if(response["KlipperScreen.conf"] == null){
            ...
            appenNotification("<strong>KlipperScreen.conf file has been modified or needs to be updated</strong>, please restore it via the Utilities page","warning");
        }
        ...
        if(response["kamp.cfg"] == null){
            ...
            appenNotification("<strong>kamp.cfg file has been modified or needs to be updated</strong>, please restore it via the Utilities page","warning");
        }
        ...
        if(response["moonraker.conf"] == null){
            ...
            appenNotification("<strong>moonraker.conf file has been modified or needs to be updated</strong>, please restore it via the Utilities page","warning");
        }
        ...
        if(response["splash.png"] == null || response["theme/custom.css"] == null || response["theme/navi.json"] == null){
            ...
            appenNotification("<strong>Warning some theme files seem to be corrupted</strong>, please restore the .theme folder via the Utilities page","warning");
        }
